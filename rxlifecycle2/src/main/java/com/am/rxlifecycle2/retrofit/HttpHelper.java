package com.am.rxlifecycle2.retrofit;

import android.support.annotation.Nullable;

import com.am.rxlifecycle2.LifecycleManager;
...
public class HttpHelper {
    ...
    private HttpHelper() {
        ...
        client = new OkHttpClient.Builder()
                ...
                .build();
        callAdapterFactory = RxJava2LifecycleCallAdapterFactory.create();
    }
    ...
    public <T> T createWithLifecycleManager(Class<T> service, String baseUrl, LifecycleManager lifecycleManager) {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(baseUrl)
                .addCallAdapterFactory(RxJava2LifecycleCallAdapterFactory.createWithLifecycleManager(lifecycleManager))
                .addConverterFactory(checkNotNull(converterFactory, "converterFactory == null"))
                .client(client)
                .build();
        return retrofit.create(service);
